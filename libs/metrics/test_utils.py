...
from libs.boxes import box_utils, draw_box_in_image
...
class YoloTest(object):
    ...
    def predict(self, image):
        ...
        image_data = yolo_preprocessing.image_resize_padding(image, [self.input_size, self.input_size])
        ...
        bboxes = box_utils.postprocess_boxes(pred_bbox, (org_h, org_w), self.input_size, self.score_threshold)
        bboxes = box_utils.nms(bboxes, self.iou_threshold)
